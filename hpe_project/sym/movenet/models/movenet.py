...
class MoveNet(nn.Module):
    ...
    '''
    def __init__(self, backbone, heads, head_conv, ft_size=64.0):
    ...
    def _top_with_center(self, center, ft_size=64):
...
def get_pose_net(num_layers, heads, head_conv=96, model_type="movenet_thunder", ft_size=64):
    assert num_layers == 0
